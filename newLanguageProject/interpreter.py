...
#  Reads the value of a variable from the  data
...
# here we do the arithmetic or comparison operation
    def compute_bin(self, left, op, right):
        ...
        if op.value == "+":
            ...
            if not self.validate_division(left, right):
...
# here we do unary arithmetic operation.
...
# Interprets and executes the given tree
